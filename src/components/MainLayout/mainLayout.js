...
const styles = {
  ...
  div: {
    padding: '230px 24px 8px 24px',
    backgroundImage:  'url(' + require('../../assets/horses2_1.jpg') + ')',
    backgroundColor: '#fff',
...
const AppBarTitle = muiThemeable()((props) => (
  <span>WAVE<span style={{color: props.muiTheme.palette.accent1Color}}>Rider</span></span>
));
